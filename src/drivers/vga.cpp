...
bool VideoGraphicsArray::SupportsMode(uint32_t width, uint32_t height, uint32_t depth){
    return width == 320 && height == 200 && depth == 8;
}
bool VideoGraphicsArray::SetMode(uint32_t width, uint32_t height, uint32_t depth){
